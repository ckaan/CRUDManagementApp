...
from clinic.building_controller import BuController
from clinic.bank_controller import BController
from clinic.controller import TController
from clinic.unit_controller import UController
...
class IntegrationTest(unittest.TestCase):
	...
	def setUp(self):
		...
		# set autosave to True to test persistence
		 self.controller = TController(autosave=True)

	# comment the tearDown method to see the file when the test ends.
	def tearDown(self):
		patients_file = 'clinic/turnovers.json'
	...
	def test_create_search_patient(self):
		...
		expected_patient_1 = Building(9790012000, "John Doe", "2000-10-10", "250 203 1010", "john.doe@gmail.com", "300 Moss St, Victoria")
		expected_patient_2 = Building(9790014444, "Mary Doe", "1995-07-01", "250 203 2020", "mary.doe@gmail.com", "300 Moss St, Victoria")
		expected_patient_3 = Building(9792225555, "Joe Hancock", "1990-01-15", "278 456 7890", "john.hancock@outlook.com", "5000 Douglas St, Saanich")
	...
	def test_retrieve_patients(self):
		...
		expected_patient_1 = Building(9798884444, "Ali Mesbah", "1980-03-03", "250 301 6060", "mesbah.ali@gmail.com", "500 Fairfield Rd, Victoria")
		expected_patient_2 = Building(9792226666, "Jin Hu", "2002-02-28", "278 222 4545", "jinhu@outlook.com", "200 Admirals Rd, Esquimalt")
		expected_patient_3 = Building(9790012000, "John Doe", "2000-10-10", "250 203 1010", "john.doe@gmail.com", "300 Moss St, Victoria")
		expected_patient_4 = Building(9790014444, "Mary Doe", "1995-07-01", "250 203 2020", "mary.doe@gmail.com", "300 Moss St, Victoria")
		expected_patient_5 = Building(9792225555, "Joe Hancock", "1990-01-15", "278 456 7890", "john.hancock@outlook.com", "5000 Douglas St, Saanich")
	...
	def test_update_patient(self):
		...
		expected_patient_3a =Building (9790012000, "John Doe", "2000-10-10", "278 999 4041", "john.doe@hotmail.com", "205 Foul Bay Rd, Oak Bay")
		...
		expected_patient_5a = Building(9793334444, "Joe Hancock", "1990-01-15", "278 456 7890", "john.hancock@gmail.com", "200 Quadra St, Victoria")
		print(f"DEBUG: Actual patient -> {actual_patient}")
		print(f"DEBUG: Expected patient -> {expected_patient_5a}")
		print(f"DEBUG: Are they equal? {actual_patient == expected_patient_5a}")
	...
	def test_set_get_current_patient(self):
		...
		expected_patient_1 = Bank(9798884444, "Ali Mesbah", "1980-03-03", "250 301 6060", "mesbah.ali@gmail.com", "500 Fairfield Rd, Victoria")
		expected_patient_2 = Bank(9792226666, "Jin Hu", "2002-02-28", "278 222 4545", "jinhu@outlook.com", "200 Admirals Rd, Esquimalt")
		expected_patient_3 = Bank(9790012000, "John Doe", "2000-10-10", "250 203 1010", "john.doe@gmail.com", "300 Moss St, Victoria")
		expected_patient_4 = Bank(9790014444, "Mary Doe", "1995-07-01", "250 203 2020", "mary.doe@gmail.com", "300 Moss St, Victoria")
		expected_patient_5 = Bank(9792225555, "Joe Hancock", "1990-01-15", "278 456 7890", "john.hancock@outlook.com", "5000 Douglas St, Saanich")
	...
	def test_create_search_note(self):
		...
		print(f"DEBUG: Notes before searching: {actual_note}")
